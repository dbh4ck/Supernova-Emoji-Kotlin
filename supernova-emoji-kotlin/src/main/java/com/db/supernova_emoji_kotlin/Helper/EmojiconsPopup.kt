...
import com.db.supernova_emoji_kotlin.Emoji.*
...
class EmojiconsPopup: PopupWindow, ViewPager.OnPageChangeListener, EmojiconRecents {
    ...
    fun setSizeForSoftKeyboard() {
        rootView!!.getViewTreeObserver().addOnGlobalLayoutListener {
            ...
            val resourceId = mContext!!.getResources()
    ...
    private fun createCustomView(): View {
        ...
        for (i in 0 until mEmojiTabs!!.size) {
            mEmojiTabs!![i]!!.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    emojisPager!!.currentItem = i
                }
            })
        }
        ...
        for (x in 0 until mEmojiTabs!!.size) {
        ...
        view!!.findViewById<View>(R.id.emojis_backspace).setOnTouchListener(RepeatListener(500, 50, object : View.OnClickListener {
    ...
    override fun addRecentEmoji(context: Context, emojicon: Emojicon) {
        val fragment = (emojisPager!!.getAdapter() as EmojisPagerAdapter).recentFragment
    ...
    companion object {
        ...
        public class RepeatListener(initialInterval: Int, normalInterval: Int, clickListener: View.OnClickListener?): View.OnTouchListener{
