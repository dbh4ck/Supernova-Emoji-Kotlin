package com.db.supernova_emoji_kotlin.Actions
...
import com.db.supernova_emoji_kotlin.Helper.EmojiconsPopup
...
import com.db.supernova_emoji_kotlin.Helper.EmojiconGridView
...
class EmojIconActions : View.OnFocusChangeListener {
    ...
    fun ShowEmojIcon() {
        ...
        popup!!.setOnDismissListener(PopupWindow.OnDismissListener { changeEmojiKeyboardIcon(this!!.emojiButton!!, SmileyIcons) })
        ...
        popup!!.setOnEmojiconClickedListener2(object : EmojiconGridView.OnEmojiconClickedListener {
            ...
            override fun onEmojiconClicked(emojicon: Emojicon) {
                ...
                val start = emojiconEditText!!.getSelectionStart()
                val end = emojiconEditText!!.getSelectionEnd()
                if (start < 0) {
